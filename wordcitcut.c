...
// This function concatenates all the segments and frees the memory
...
// This function initializes all the segments to NULL
...
{
    write(1, "In words: ", 10); // Print "In words: "
    write(1, result, strlen(result)); // Print the result
    write(1, "\n", 1); // Print a newline
}
